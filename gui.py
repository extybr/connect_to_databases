...
class UiForm(object):
    ...
    def retranslate_ui(self, Form):
        ...
        self.lineEdit_4.setText(_translate("Form", "my-password"))
        self.lineEdit_5.setText(_translate("Form", "my-database.db"))
        self.lineEdit_6.setText(_translate("Form", "my-table"))
