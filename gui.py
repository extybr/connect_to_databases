...
class UiForm(object):
    def setup_ui(self, form):
        ...
        self.comboButton = QtWidgets.QComboBox(self.groupBox)
        font = QtGui.QFont()
        font.setPixelSize(16)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.gridLayout.addWidget(self.comboButton, 4, 7, 1, 1)
    ...
    def translate_ui(self):
        ...
        self.radioButton.setText(_translate("form", "SQLite"))
        ...
        self.comboButton.addItems(['', 'sqlite', 'postgresql', 'mysql', 'mssql'])
